...
function toggleIcon(e) {
	$(e.target)
		...
		.find('.panel-title a')
		.toggleClass('active')
		.find("http://websites.simplesphere.net/sales/version2/js/i.fa")
...
$('#banner-form').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: 'http://websites.simplesphere.net/sales/version2/js/banner-form.php', // Your form script
        data: post_data,
...
$('#middle-form').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: 'http://websites.simplesphere.net/sales/version2/js/middle-form.php', // Your form script
        data: post_data,
        success: function(msg) {
            $(form).fadeOut(500, function() {
                form.html(msg).fadeIn();
...
$('#contact-form').on('submit', function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: 'http://websites.simplesphere.net/sales/version2/js/contact-form.php', // Your form script
        data: post_data,
        success: function(msg) {
            $(form).fadeOut(500, function() {
                form.html(msg).fadeIn();
