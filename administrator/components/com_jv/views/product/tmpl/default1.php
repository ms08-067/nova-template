...
<label class="required invalid" id="" aria-invalid="true">Title</label></div>
<div class="controls">
<input style="width: 100%;" type="text" aria-required="true" required="" size="40" class="input-large-text invalid"  id="title" name="title" aria-invalid="true">
</div>
</div>
</div>
...
<input style="width: 100%;" type="text" size="40" id="short_des" name="short_des">
...
<div class="control-label"><label>Intro Image</label></div>
...
<a title="Select" class="modal btn">
