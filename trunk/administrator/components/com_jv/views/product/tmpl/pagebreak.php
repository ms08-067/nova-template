...
?>
		...
		<table>
			<tr>
				<td class="key" align="right">
					<label for="title">
						<?php echo JText::_('com_jv_PAGEBREAK_TITLE'); ?>
					</label>
				</td>
				<td>
			...
			<tr>
				<td class="key" align="right">
					<label for="alias">
						<?php echo JText::_('com_jv_PAGEBREAK_TOC'); ?>
					</label>
				</td>
				<td>
	...
	<button onclick="insertPagebreak();"><?php echo JText::_('com_jv_PAGEBREAK_INSERT_BUTTON'); ?></button>
